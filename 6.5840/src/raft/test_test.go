...
func TestReElection2A(t *testing.T) {
	...
	fmt.Println("leader1 is ", leader1)
	...
	fmt.Printf("raft %d rejoin into raft group", leader1)
	cfg.connect(leader1)
	leader2 := cfg.checkOneLeader()

	fmt.Println("leader2 is ", leader2)
...
func TestRejoin2B(t *testing.T) {
	...
	fmt.Printf("reconnect leader1 %d\n", leader1)
	cfg.connect(leader1)
...
// fmt.Printf("raft %d log length %d", leader1, len(cfg.rafts[leader1].logs)) 52
// fmt.Printf("raft %d log length %d", leader1+1, len(cfg.rafts[(leader1+1)%5].logs)) 52
...
// old group
// fmt.Printf("raft %d log length %d, commit index %d", leader1, len(cfg.rafts[leader1].logs), cfg.rafts[leader1].commitIndex)
// fmt.Println()
// fmt.Printf("raft %d log length %d, commit index %d", (leader1+1)%servers, len(cfg.rafts[(leader1+1)%servers].logs), cfg.rafts[(leader1+1)%servers].commitIndex)
// fmt.Println()

// new group
// fmt.Printf("raft %d log length %d, commit index %d", (leader1+2)%servers, len(cfg.rafts[(leader1+2)%servers].logs), cfg.rafts[(leader1+2)%servers].commitIndex)
// fmt.Println()
// fmt.Printf("raft %d log length %d, commit index %d", (leader1+3)%servers, len(cfg.rafts[(leader1+3)%servers].logs), cfg.rafts[(leader1+3)%servers].commitIndex)
// fmt.Println()
// fmt.Printf("raft %d log length %d, commit index %d\n", (leader1+4)%servers, len(cfg.rafts[(leader1+4)%servers].logs), cfg.rafts[(leader1+4)%servers].commitIndex)
// fmt.Println()
...
// fmt.Printf("raft %d log length %d, commit index %d", (leader1+3)%servers, len(cfg.rafts[(leader1+3)%servers].logs), cfg.rafts[(leader1+3)%servers].commitIndex)
// fmt.Println()
// fmt.Printf("raft %d log length %d, commit index %d", (leader1+4)%servers, len(cfg.rafts[(leader1+4)%servers].logs), cfg.rafts[(leader1+4)%servers].commitIndex)
// fmt.Println()
...
// new group
// leader1+2 		 	1 2 3 ... 51/ 52 ... 100 101
// leader1+3 (other) 	1 2 3 ... 51/
// leader1+4 			1 2 3 ... 51/ 52 ... 100 101
...
// // reconnect leader1, leader1 + 1 and other 4 5 2
// fmt.Printf("leader1 %d,  lastlogterm is %d, lastlogindex %d, log length %d, commit index %d", leader1, cfg.rafts[leader1%servers].LastLogTerm(), cfg.rafts[leader1%servers].LastLogIndex(), len(cfg.rafts[leader1%servers].logs), cfg.rafts[leader1%servers].commitIndex)
// fmt.Println()
// fmt.Printf("leader1+1 %d, lastlogterm is %d, lastlogindex %d, log length %d, commit index %d", (leader1+1)%servers, cfg.rafts[(leader1+1)%servers].LastLogTerm(), cfg.rafts[(leader1+1)%servers].LastLogIndex(), len(cfg.rafts[(leader1+1)%servers].logs), cfg.rafts[(leader1+1)%servers].commitIndex)
// fmt.Println()
// fmt.Printf("other %d,  lastlogterm is %d, lastlogindex %d, log length %d, commit index %d", other, cfg.rafts[other%servers].LastLogTerm(), cfg.rafts[other%servers].LastLogIndex(), len(cfg.rafts[other%servers].logs), cfg.rafts[other%servers].commitIndex)
// fmt.Println()
